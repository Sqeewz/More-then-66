...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#050814]/95 backdrop-blur-md px-4 md:px-6 lg:px-8 py-3 shadow-lg">
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-4">
        
        {/* Brand Logo & Name: One 4 All (Far Left & Bigger) */}
        <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-start">
          <Link href="/" className="flex items-center gap-3 group">
            <img src="/logo.png" alt="One 4 All Logo" className="w-10 h-10 md:w-12 md:h-12 rounded-xl object-contain group-hover:scale-105 transition-transform drop-shadow-md" />
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] px-2.5 py-0.5 rounded-full bg-gradient-to-r from-sky-500/20 via-indigo-500/20 to-purple-500/20 text-sky-300 font-extrabold border border-sky-400/40 uppercase tracking-wider">
                  CS 67
                </span>
              </div>
            </div>
      ...
      <div className="w-full mt-2 pt-2 border-t border-white/5 flex items-center gap-1 overflow-x-auto no-scrollbar pb-0.5 text-xs">
